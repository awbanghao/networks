...
write.csv(weightsxl, "weightsxl.csv")
# browseURL("weightsxl.csv")

predictabilityxl <- predictability$errors
write.csv(predictabilityxl, "predictabilityxl.csv")
# browseURL("predictabilityxl.csv")

bridgexl <- bridge$`Bridge Expected Influence (1-step`
write.csv(bridgexl, "bridgexl.csv")
# browseURL("bridgexl.csv")
```
